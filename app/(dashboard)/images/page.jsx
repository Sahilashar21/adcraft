...
import { ImageIcon, Calendar, Download, Copy, Check, ArrowLeft, Target, Building, Sparkles, Palette, Users, Monitor, DollarSign } from "lucide-react";
      ...
      >
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                {selectedCampaign ? `Images for ${selectedCampaign.name}` : 'AI Image Generator'}
              </motion.h2>
            </div>
            <motion.div variants={itemVariants}>
              <Link href="/">
          ...
          {!selectedCampaign ? (
            ...
            // Image Generation and Display View
                  ...
                  {loading ? (
                    <div className="flex justify-center items-center min-h-[400px]">
                      <div className="text-center">
                        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-purple-400 mx-auto mb-4"></div>
                        <p className="text-purple-200">Loading images...</p>
                      </div>
                    </div>
                  ) : images.length === 0 ? (
                    <div className="flex flex-1 items-center justify-center rounded-lg border border-white/20 bg-white/5 backdrop-blur-xl shadow-2xl shadow-purple-500/10 min-h-[400px]">
                      <div className="flex flex-col items-center gap-1 text-center">
                        ...
                        <p className="text-sm text-purple-200">
                          Use the form to create your first AI-generated advertisement image.
                        </p>
                      </div>
                    </div>
                  ) : (
          ...
          {selectedCampaign && images.length > 0 && (
            ...
            >
              Showing {images.length} generated image{images.length !== 1 ? 's' : ''} for {selectedCampaign.name}
            </motion.div>
          )}
        </div>
      </motion.div>
